...
create streaming table guru_silver.sales_cleaned_pl
...
CREATE OR REFRESH STREAMING TABLE guru_silver.products_cleaned;

CREATE FLOW product_flow
AS AUTO CDC INTO
  guru_silver.products_cleaned
...
CREATE OR REFRESH STREAMING TABLE guru_silver.customers_cleaned;
CREATE FLOW customer_flow
AS AUTO CDC INTO
  guru_silver.customers_cleaned
